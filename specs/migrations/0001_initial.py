# Generated by Django 3.2.8 on 2021-10-17 08:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='alcohol.product', verbose_name='Товар')),
            ],
        ),
        migrations.CreateModel(
